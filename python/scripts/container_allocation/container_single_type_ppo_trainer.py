...
mdp_version = "2_no_DD_no_types"
path_to_json = dynaplex.filepath("mdp_config_examples", folder_name, f"mdp_config_{mdp_version}.json")
try:
...
def save_best_fn(policy):
    ...
    dynaplex.save_policy(policy.actor.wrapped_module,
                   {'input_type': 'dict', 'num_inputs': mdp.num_flat_features(), 'num_outputs': mdp.num_valid_actions(), 'id': 'ppo-run' },
                   save_path)
...
if __name__ == '__main__':
    for gamma in [50]:  # Cent. depot outflow rate
